                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-12">
                            <div className="ar-hero-title-box tp_fade_anim" data-delay=".3">
                                <h3 className="ar-about-us-4-title">Trusted Chemical &amp; Lubricant <br />
                                    Supplier Since 2001</h3>
                                <div className="ar-about-us-4-title-box d-flex justify-content-end">
                                    ...
                                    <p>An independent Sadguru Sales Agency is a trusted supplier of industrial chemicals <br />
                                        and lubricants in Bhuj, Kutch — established in 2001, <br /> serving businesses with quality products and reliable service.</p>
                                </div>
                            </div>
                        </div>
                    </div>
